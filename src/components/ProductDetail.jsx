...
const ProductDetail = () => {
  ...
  return (
    <>
      <div className="p-6 max-w-8xl mx-auto grid md:grid-cols-2 gap-8">
        <div>
          <img
            src={product.image}
            alt={product.name}
        ...
        <div className="space-y-4 flex-grow">
          ...
          <a
            href={`https://wa.me/234XXXXXXXXXX?text=I'm%20interested%20in%20the%20${encodeURIComponent(product.name)}`}
            target="_blank"
